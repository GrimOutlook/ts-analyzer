...
mod tests {
    ...
    fn packet_1() -> (Box<[u8]>, AdaptationFieldControl, Box<[u8]>) {
        let packet = [
            ...
            0x00, 0x01, 0xFC, 0x01, 0x10, 0x84, 0x80, 0x05, 0x21, 0x02, 0x95, 0x32, 0x6F,
        ...
        return (Box::new(packet), crate::AdaptationFieldControl::Payload, Box::new([0x00, 0x01, 0xFC, 0x01]));
    }
